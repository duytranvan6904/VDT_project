...
Hàm `APF_Planner` triển khai thuật toán **Improved Artificial Potential Field (IAPF)** để tạo lệnh vận tốc cho UAV trong không gian 3D.
...
```matlab
[V_cmd, yaw_cmd, Stop] = APF_Planner( ...
