...
private:
  ...
  void on_planner(const offboard_manager::msg::PlannerOutput::SharedPtr msg);

  void update();
  void log_debug(const fsm_state_machine::msg::TimeoutFlags & flags) const;
  ...
  rclcpp::Subscription<offboard_manager::msg::PlannerOutput>::SharedPtr planner_sub_;
  rclcpp::Publisher<fsm_state_machine::msg::TimeoutFlags>::SharedPtr timeout_pub_;
